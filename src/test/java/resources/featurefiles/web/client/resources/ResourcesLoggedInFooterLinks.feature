@ResourcesPageFooterLinks  @Regression @Web @Client5 @ReleaseRegression2 @Traffic
Feature: Client Resources ResourcesLoggedInFooterLinks
  ...
  Scenario: Navigation Footer for logged In user on resources blog page
    ...
    When   I click on link "Saved Resumes" in "Resume Search" footer
    Then   I should be able to see in browser URL "Client My Saved Resumes"
    Then   I should see text H one tag "My Saved Resumes"

    When   I click on link "Unlocked Resumes" in "Resume Search" footer
    ...
    And   I should see text span tags "Post"
    And   I should see text span tags "Search"
    And   I should see text span tags "Hire"